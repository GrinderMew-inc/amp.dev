...
- Either:
    ...
    - *or* [CodePen](https://codepen.io/), [Glitch](https://glitch.com/) or a similar online playground
...
[tip type="note"] Since the code we've provided you doesn't include a webservice that handles form submissions, submitting the form won't do anything useful. Of course, you're welcome to add this feature to your own code! [/tip]
...
[tip type="note"] If you don't have this extension, append `#development=1` to your URL, and AMP will output validation errors to your Console. [/tip]
